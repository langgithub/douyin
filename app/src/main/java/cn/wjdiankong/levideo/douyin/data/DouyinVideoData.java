package cn.wjdiankong.levideo.douyin.data;
...
public class DouyinVideoData extends LevideoData{
	...
	public static DouyinVideoData fromJSONData(String jsonStr){
		...
		try{
			...
			data.firstVideoPlayUrl = playAddJson.getJSONArray("url_list").getString(0);
			data.secondVideoPlayUrl = playAddJson.getJSONArray("url_list").getString(1);
			data.thirdVideoPlayUrl = playAddJson.getJSONArray("url_list").getString(2);
			JSONObject downloadJson = videoJson.getJSONObject("download_addr");
			data.firstVideoDownloadUrl = downloadJson.getJSONArray("url_list").getString(0);
			data.secondVideoDownloadUrl = downloadJson.getJSONArray("url_list").getString(1);
			data.thirdVideoDownloadUrl = downloadJson.getJSONArray("url_list").getString(2);
